...
Narrated 80-second demo: available as the `metafence-webmcp-demo.mp4` asset on the latest GitHub release. The opening was tightened against the organizer’s final evaluator guidance: substantive context begins immediately and the working record table is visible by 11.8 seconds. Upload-ready corrected English captions are in [`demo-assets/metafence-webmcp-demo.en.srt`](demo-assets/metafence-webmcp-demo.en.srt).
